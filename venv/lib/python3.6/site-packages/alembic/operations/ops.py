...
class CreatePrimaryKeyOp(AddConstraintOp):
    ...
    def to_constraint(self, migration_context=None):
        ...
        return schema_obj.primary_key_constraint(
            self.constraint_name, self.table_name, self.columns, schema=self.schema
        )

    @classmethod
    @util._with_legacy_names([("name", "constraint_name"), ("cols", "columns")])
...
class CreateUniqueConstraintOp(AddConstraintOp):
    ...
    def create_unique_constraint(
        cls, operations, constraint_name, table_name, columns, schema=None, **kw
    ):
...
class CreateCheckConstraintOp(AddConstraintOp):
    ...
    @classmethod
    @util._with_legacy_names([("name", "constraint_name"), ("source", "table_name")])
    def create_check_constraint(
        cls, operations, constraint_name, table_name, condition, schema=None, **kw
    ):
...
class DropIndexOp(MigrateOperation):
    ...
    def to_index(self, migration_context=None):
        ...
        return schema_obj.index(
            self.index_name, self.table_name, ["x"], schema=self.schema, **self.kw
        )

    @classmethod
    @util._with_legacy_names([("name", "index_name"), ("tablename", "table_name")])
...
class AddColumnOp(AlterTableOp):
    ...
    def batch_add_column(cls, operations, column):
        ...
        """
        op = cls(operations.impl.table_name, column, schema=operations.impl.schema)
        return operations.invoke(op)
...
class DropColumnOp(AlterTableOp):
    ...
    def batch_drop_column(cls, operations, column_name, **kw):
        ...
        """
        op = cls(
            operations.impl.table_name, column_name, schema=operations.impl.schema, **kw
        )
        return operations.invoke(op)
