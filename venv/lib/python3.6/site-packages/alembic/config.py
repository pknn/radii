...
class Config(object):
    ...
    def print_stdout(self, text, *arg):
        ...
        util.write_outstream(self.stdout, (compat.text_type(text) % arg), "\n")
...
class CommandLine(object):
    ...
    def _generate_args(self, prog):
        def add_options(parser, positional, kwargs):
            kwargs_opts = {
                ...
                "indicate_current": (
                    "-i",
                    "--indicate-current",
                    dict(action="store_true", help="Indicate the current revision"),
                ),
            }
            positional_help = {
        ...
        parser.add_argument(
            "--raiseerr", action="store_true", help="Raise a full stack trace on error"
        )
