...
class CMSVersion(Integer):
    _map = {0: "v0", 1: "v1", 2: "v2", 3: "v3", 4: "v4", 5: "v5"}
...
class Time(Choice):
    _alternatives = [("utc_time", UTCTime), ("generalized_time", GeneralizedTime)]
...
class CMSAttribute(Sequence):
    _fields = [("type", CMSAttributeType), ("values", None)]
...
class DigestedObjectType(Enumerated):
    _map = {0: "public_key", 1: "public_key_cert", 2: "other_objy_types"}
...
class AttCertIssuer(Choice):
    _alternatives = [("v1_form", GeneralNames), ("v2_form", V2Form, {"explicit": 0})]
...
class LeapData(Sequence):
    _fields = [("leap_time", BigTime), ("action", Integer)]
...
class AttCertAttribute(Sequence):
    _fields = [("type", AttCertAttributeType), ("values", None)]
...
class OtherCertificateFormat(Sequence):
    _fields = [("other_cert_format", ObjectIdentifier), ("other_cert", Any)]
...
class IssuerAndSerialNumber(Sequence):
    _fields = [("issuer", Name), ("serial_number", Integer)]
...
class OtherRevInfoFormatId(ObjectIdentifier):
    _map = {"1.3.6.1.5.5.7.16.2": "ocsp_response", "1.3.6.1.5.5.7.16.4": "scvp"}


class OtherRevocationInfoFormat(Sequence):
    _fields = [("other_rev_info_format", OtherRevInfoFormatId), ("other_rev_info", Any)]

    _oid_pair = ("other_rev_info_format", "other_rev_info")
    _oid_specs = {"ocsp_response": OCSPResponse, "scvp": SCVPReqRes}
...
class OtherKeyAttribute(Sequence):
    _fields = [("key_attr_id", ObjectIdentifier), ("key_attr", Any)]
...
class RecipientEncryptedKey(Sequence):
    _fields = [("rid", KeyAgreementRecipientIdentifier), ("encrypted_key", OctetString)]
...
class OtherRecipientInfo(Sequence):
    _fields = [("ori_type", ObjectIdentifier), ("ori_value", Any)]
...
class CompressionAlgorithmId(ObjectIdentifier):
    _map = {"1.2.840.113549.1.9.16.3.8": "zlib"}
