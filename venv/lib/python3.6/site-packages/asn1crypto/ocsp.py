...
class ServiceLocator(Sequence):
    _fields = [("issuer", Name), ("locator", AuthorityInfoAccessSyntax)]


class RequestExtensionId(ObjectIdentifier):
    _map = {"1.3.6.1.5.5.7.48.1.7": "service_locator"}
...
class RequestExtension(Sequence):
    ...
    _oid_specs = {"service_locator": ServiceLocator}
...
class ResponseType(ObjectIdentifier):
    _map = {"1.3.6.1.5.5.7.48.1.1": "basic_ocsp_response"}
...
class ResponseDataExtensionId(ObjectIdentifier):
    _map = {"1.3.6.1.5.5.7.48.1.2": "nonce", "1.3.6.1.5.5.7.48.1.9": "extended_revoke"}
...
class ResponseDataExtension(Sequence):
    ...
    _oid_pair = ("extn_id", "extn_value")
    _oid_specs = {"nonce": OctetString, "extended_revoke": Null}
...
class ResponseBytes(Sequence):
    _fields = [("response_type", ResponseType), ("response", ParsableOctetString)]

    _oid_pair = ("response_type", "response")
    _oid_specs = {"basic_ocsp_response": BasicOCSPResponse}
