...
class SpecifiedECDomainVersion(Integer):
    ...
    _map = {1: "ecdpVer1", 2: "ecdpVer2", 3: "ecdpVer3"}
...
class CharacteristicTwo(Sequence):
    ...
    _oid_specs = {"gn_basis": Null, "tp_basis": Integer, "pp_basis": Pentanomial}
...
class FieldID(Sequence):
    ...
    _oid_specs = {"prime_field": Integer, "characteristic_two_field": CharacteristicTwo}
...
class PrivateKeyAlgorithm(_ForceNullParameters, Sequence):
    ...
    _oid_specs = {"dsa": DSAParams, "ec": ECDomainParameters}
...
class PrivateKeyInfo(Sequence):
    ...
    def _private_key_spec(self):
        ...
        return {"rsa": RSAPrivateKey, "dsa": Integer, "ec": ECPrivateKey}[algorithm]
    ...
    def _compute_public_key(self):
        ...
        if self.algorithm == "rsa":
            ...
            return RSAPublicKey(
                {"modulus": key["modulus"], "public_exponent": key["public_exponent"]}
            )
        ...
        if self.algorithm == "ec":
            ...
            if curve_type == "specified":
                ...
                base_x, base_y = (
                    self["private_key_algorithm"]["parameters"]
                    .chosen["base"]
                    .to_coords()
                )
