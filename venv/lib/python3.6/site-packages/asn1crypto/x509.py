...
class NameTypeAndValue(Sequence):
    _fields = [("type", NameType), ("value", Any)]
...
class AnotherName(Sequence):
    _fields = [("type_id", ObjectIdentifier), ("value", Any, {"explicit": 0})]
...
class AdministrationDomainName(Choice):
    ...
    _alternatives = [("numeric", NumericString), ("printable", PrintableString)]
...
class BuiltInDomainDefinedAttribute(Sequence):
    _fields = [("type", PrintableString), ("value", PrintableString)]
...
class TeletexDomainDefinedAttribute(Sequence):
    _fields = [("type", TeletexString), ("value", TeletexString)]
...
class Validity(Sequence):
    _fields = [("not_before", Time), ("not_after", Time)]
...
class PolicyQualifierInfo(Sequence):
    _fields = [("policy_qualifier_id", PolicyQualifierId), ("qualifier", Any)]
...
class AccessDescription(Sequence):
    _fields = [("access_method", AccessMethod), ("access_location", GeneralName)]
...
class TPMSpecification(Sequence):
    _fields = [("family", UTF8String), ("level", Integer), ("revision", Integer)]
...
class TCGPlatformSpecification(Sequence):
    _fields = [("version", TCGSpecificationVersion), ("platform_class", OctetString)]
...
class EKGenerationLocation(Enumerated):
    _map = {0: "tpm_manufacturer", 1: "platform_manufacturer", 2: "ek_cert_signer"}
...
class SecurityLevel(Enumerated):
    _map = {1: "level1", 2: "level2", 3: "level3", 4: "level4"}
...
class SubjectDirectoryAttribute(Sequence):
    _fields = [("type", SubjectDirectoryAttributeId), ("values", Any)]
