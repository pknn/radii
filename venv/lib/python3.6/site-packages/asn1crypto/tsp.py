...
class MessageImprint(Sequence):
    _fields = [("hash_algorithm", DigestAlgorithm), ("hashed_message", OctetString)]
...
class TimeStampResp(Sequence):
    _fields = [("status", PKIStatusInfo), ("time_stamp_token", ContentInfo)]
...
class OtherEvidence(Sequence):
    _fields = [("oe_type", ObjectIdentifier), ("oe_value", Any)]
...
class IssuerSerial(Sequence):
    _fields = [("issuer", GeneralNames), ("serial_number", Integer)]
