...
class AlgorithmIdentifier(Sequence):
    _fields = [("algorithm", ObjectIdentifier), ("parameters", Any, {"optional": True})]
...
class HmacAlgorithm(Sequence):
    _fields = [("algorithm", HmacAlgorithmId), ("parameters", Any, {"optional": True})]
...
class DigestInfo(Sequence):
    _fields = [("digest_algorithm", DigestAlgorithm), ("digest", OctetString)]
...
class RSASSAPSSParams(Sequence):
    _fields = [
        ...
        ("salt_length", Integer, {"explicit": 2, "default": 20}),
        ("trailer_field", TrailerField, {"explicit": 3, "default": "trailer_field_bc"}),
    ]
...
class Pbkdf2Salt(Choice):
    _alternatives = [("specified", OctetString), ("other_source", AlgorithmIdentifier)]
...
class Pbes1Params(Sequence):
    _fields = [("salt", OctetString), ("iterations", Integer)]
...
class EncryptionAlgorithm(_ForceNullParameters, Sequence):
    ...
    def key_length(self):
        ...
        if encryption_algo[0:3] == "aes":
            return {"aes128_": 16, "aes192_": 24, "aes256_": 32}[encryption_algo[0:7]]

        cipher_lengths = {"des": 8, "tripledes_3key": 24}
        ...
        if encryption_algo == "rc2":
            rc2_params = (
                self["parameters"].parsed["encryption_scheme"]["parameters"].parsed
            )
    ...
    def encryption_block_size(self):
        ...
        cipher_map = {"des": 8, "tripledes_3key": 8, "rc2": 8}
...
class Pkcs5MacAlgorithm(Sequence):
    _fields = [("algorithm", Pkcs5MacId), ("parameters", Any)]
...
class AnyAlgorithmIdentifier(_ForceNullParameters, Sequence):
    _fields = [("algorithm", AnyAlgorithmId), ("parameters", Any, {"optional": True})]
