    ...
    if length_octet >> 7 == 0:
        ...
        if length_octets:
            ...
            while contents_end < data_len:
                sub_header_end, contents_end = _parse(
                    encoded_data, data_len, contents_end, lengths_only=True
                )
                if (
                    contents_end == sub_header_end
                    and encoded_data[contents_end - 2 : contents_end] == b"\x00\x00"
                ):
                    break
            if lengths_only:
                return (pointer, contents_end)
